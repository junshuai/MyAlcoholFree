...
Product.create!(
  ...
  thumbnail_url: 'http://www.alcoholfree.co.uk/images/scheurebe_thumb180.jpg',
  price: 7.29,
  aupplier: 'apple'
)
...
Product.create!(
  ...
  thumbnail_url: 'http://www.alcoholfree.co.uk/images/emina_red_thumb180.jpg',
  price: 6.99,
  aupplier: 'apple'
)
...
Product.create!(
  ...
  thumbnail_url: 'http://www.alcoholfree.co.uk/images/cab_sauv_bio_thumb180.jpg',
  price: 7.99,
  aupplier: 'apple'
)
...
Product.create!(
  ...
  thumbnail_url: 'http://www.alcoholfree.co.uk/images/emina_white_thumb180.jpg',
  price: 6.99,
  aupplier: 'apple'
)
