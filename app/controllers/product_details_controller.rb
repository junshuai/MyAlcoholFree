class ProductDetailsController < ApplicationController
  ...
  private
    ...
    def product_detail_params
      params.require(:product_detail).permit(:product_id, :image_url, :long_description, :manufacturer, :country_of_origin, :volume_in_liter, :alcohol_by_volume, :calories_in_kcal_per_100ml, :grape_type)
    end
end
